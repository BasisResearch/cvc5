...
; EXPECT: (summary :classes 3 :candidates 4 :focus 0 :focus-found 0 :used-omitted 1 :too-large 0 :trivial-omitted 0)
...
; EXPECT: )
; EXPECT: (egraph-equalities
; EXPECT: (summary :classes 3 :candidates 5 :focus 0 :focus-found 0 :used-omitted 0 :too-large 0 :trivial-omitted 0)
...
; EXPECT: )
; EXPECT: (egraph-equalities
; EXPECT: (summary :classes 1 :candidates 2 :focus 1 :focus-found 1 :used-omitted 0 :too-large 0 :trivial-omitted 0)
...
; EXPECT: sat
; EXPECT: (egraph-equalities
; EXPECT: (summary :classes 1 :candidates 1 :focus 0 :focus-found 0 :used-omitted 0 :too-large 0 :trivial-omitted 0)
