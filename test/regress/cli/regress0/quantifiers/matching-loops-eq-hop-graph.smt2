...
; EXPECT: (node 4 0 QUANTIFIERS_INST_E_MATCHING R 4 2 (3) (eq 2))
; EXPECT: (node 5 1 QUANTIFIERS_INST_E_MATCHING_SIMPLE R 5 3 (4))
; EXPECT: (node 6 0 QUANTIFIERS_INST_E_MATCHING R 6 3 (5) (eq 4))
; EXPECT: (node 7 1 QUANTIFIERS_INST_E_MATCHING_SIMPLE R 7 4 (6))
; EXPECT: (node 8 0 QUANTIFIERS_INST_E_MATCHING R 8 4 (7) (eq 6))
