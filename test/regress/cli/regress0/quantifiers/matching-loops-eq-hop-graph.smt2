...
; EXPECT: (node 2 0 QUANTIFIERS_INST_E_MATCHING R 2 1 (1) (eq 0))
; EXPECT: (node 3 1 QUANTIFIERS_INST_E_MATCHING_SIMPLE R 3 2 (2) (eq 0))
; EXPECT: (node 4 0 QUANTIFIERS_INST_E_MATCHING R 4 2 (3) (eq 0 2))
; EXPECT: (node 5 1 QUANTIFIERS_INST_E_MATCHING_SIMPLE R 5 3 (4) (eq 0 2))
; EXPECT: (node 6 0 QUANTIFIERS_INST_E_MATCHING R 6 3 (5) (eq 0 2 4))
; EXPECT: (node 7 1 QUANTIFIERS_INST_E_MATCHING_SIMPLE R 7 4 (6) (eq 0 2 4))
; EXPECT: (node 8 0 QUANTIFIERS_INST_E_MATCHING R 8 4 (7) (eq 0 2 4 6))
; EXPECT: (node 9 1 QUANTIFIERS_INST_E_MATCHING_SIMPLE R 9 5 (8) (eq 0 2 4 6))
; EXPECT: (dropped 0)
; EXPECT: )
