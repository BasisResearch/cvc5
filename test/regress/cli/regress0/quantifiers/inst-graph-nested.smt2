...
; EXPECT: (node 2 0 QUANTIFIERS_INST_E_MATCHING R 2 2 (1))
; EXPECT: (node 3 0 QUANTIFIERS_INST_E_MATCHING R 3 3 (2))
; EXPECT: (node 4 0 QUANTIFIERS_INST_E_MATCHING R 4 4 (3))
; EXPECT: (dropped 0)
; EXPECT: )
