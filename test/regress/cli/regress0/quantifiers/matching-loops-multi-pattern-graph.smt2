; COMMAND-LINE: --matching-loops --inst-graph --inst-max-rounds=8 --user-pat=strict
...
; matching-loops-multi-pattern.smt2 with the graph on: the report must not
; change. two_pats has two patterns and only the second, (k x), ever matches. The
