...
; EXPECT: unsat
; EXPECT: (:nl-frontier (:result unsat :reason none :enabled true :checks 12 :rounds 12 :punts 0 :last lemma :atoms ((:atom (* b c) :kind product :current true :rounds 12 :value 4 :from-args 6 :lower (:value 2 :strict false :fixed false) :args ((:term b :value 3 :lower (:value 3 :strict false :fixed true)) (:term c :value 2 :lower (:value 2 :strict false :fixed false))) :hosts ((:in input :term (* b c) :tags (query)))) (:atom (* b c (EucDiv a (* b c))) :kind product :current true :rounds 12 :value 7 :from-args 12 :lower (:value 0 :strict false :fixed false) :args ((:term b :value 3 :lower (:value 3 :strict false :fixed true)) (:term c :value 2 :lower (:value 2 :strict false :fixed false)) (:term (EucDiv a (* b c)) :value 2 :lower (:value 2 :strict false :fixed false))) :hosts ()) (:atom (* b c (div a (* b c))) :kind division :current true :rounds 10 :value 6 :from-args 12 :lower (:value 2 :strict false :fixed false) :args ((:term b :value 3 :lower (:value 3 :strict false :fixed true)) (:term c :value 2 :lower (:value 2 :strict false :fixed false)) (:term (div a (* b c)) :value 2 :lower (:value 2 :strict false :fixed false))) :hosts ((:in instance :term (EucDiv a (* b c)) :qid prelude_eucdiv :count 1))) (:atom (* b (div a b)) :kind division :current true :rounds 8 :value 4 :from-args 6 :lower (:value 1 :strict false :fixed false) :args ((:term b :value 3 :lower (:value 3 :strict false :fixed true)) (:term (div a b) :value 2 :lower (:value 2 :strict false :fixed false))) :hosts ((:in input :term (div a b) :tags (hyp_div))))) :omitted 0 :truncated false))
; EXPECT: unsat
; EXPECT: (:nl-frontier (:result unsat :reason none :enabled true :checks 6 :rounds 6 :punts 0 :last lemma :atoms ((:atom (* b (div a b)) :kind division :current true :rounds 6 :value 2 :from-args 6 :args ((:term b :value 3 :lower (:value 3 :strict false :fixed true)) (:term (div a b) :value 2)) :hosts ((:in input :term (div a b) :tags (hyp_div)))) (:atom (* b (EucDiv a (* 2 b))) :kind product :current true :rounds 6 :value 4 :from-args 3 :lower (:value 4 :strict false :fixed false) :upper (:value 4 :strict false :fixed false) :args ((:term b :value 3 :lower (:value 3 :strict false :fixed true)) (:term (EucDiv a (* 2 b)) :value 1 :lower (:value 1 :strict false :fixed false) :upper (:value 1 :strict false :fixed false))) :hosts ((:in input :term (* (* 2 b) (EucDiv a (* 2 b))) :tags (query)))) (:atom (* b (div a (* 2 b))) :kind division :current true :rounds 6 :value 2 :from-args 3 :lower (:value 2 :strict false :fixed false) :args ((:term b :value 3 :lower (:value 3 :strict false :fixed true)) (:term (div a (* 2 b)) :value 1 :lower (:value 1 :strict false :fixed false) :upper (:value 1 :strict false :fixed false))) :hosts ((:in input :term (EucDiv a (* 2 b)) :tags (query)) (:in instance :term (EucDiv a (* 2 b)) :qid prelude_eucdiv :count 1)))) :omitted 0 :truncated false))
